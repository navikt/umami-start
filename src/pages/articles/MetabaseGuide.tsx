...
const MetabaseGuide = () => {
  return (
    <div className="w-full max-w-[800px] mx-auto">
      ...
      {/* Introduction box */}
      <Box className="mb-8 bg-[var(--ax-bg-accent-soft)] p-6 border border-[var(--ax-border-subtle)] rounded-medium">
      ...
      <div className="prose max-w-full prose-lg">
        <VStack gap="space-12">
          ...
          <section id="steg2-grafbygger">
            ...
            <Heading level="3" size="xsmall" spacing className="mt-8 ml-8">
