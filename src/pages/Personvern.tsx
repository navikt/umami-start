            ...
            <main>
                <div className="mt-12 px-4" style={{maxWidth: "600px", marginLeft: "auto", marginRight: "auto"}}>
                    ...
                    <div className="mb-12 mt-5 max-w-2xl font-serif">
                        ...
                        <p className="mb-4 leading-normal">Opplysningene brukes til å kartlegge hvordan og hvor mye nettsiden brukes, uten å identifisere IP-adresser. Vi bruker verktøyet Umami i analysearbeidet.
                        </p>
