...
function Home() {
    return (
        <>
            <Heading spacing={true} as="h2" size="large" style={{marginTop: "100px"}}>Mål brukeradferd med
                Umami</Heading>
            <Dashboard/>

            <Heading spacing={true} as="h3" size="medium" style={{ marginTop: "103px"}}>Hvem bruker Umami?</Heading>
