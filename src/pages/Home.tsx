...
function Home() {
    return (
        <>
            <Heading spacing={true} as="h2" size="large" style={{ marginTop: "60px" }}>Mål brukeradferd med Umami</Heading>
            <Dashboard/>

            <Heading spacing={true} as="h3" size="medium" style={{ marginTop: "63px" }}>Hvem bruker Umami?</Heading>
