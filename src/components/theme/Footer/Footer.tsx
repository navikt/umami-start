...
function Kontakt() {
    return (
        <div>
            ...
            <BodyShort as="ul" className="mt-3 grid gap-3">
                <FooterLink href="https://nav-it.slack.com/archives/C070BPKR830">
                    ...
                    #produktanalyse på Slack
                </FooterLink>
                <FooterLink href="https://github.com/navikt/umami#readme">
